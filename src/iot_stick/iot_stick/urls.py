...
from .views import IndexView, HomeLocationCreateView, HomeLocationUpdateView, HomeDeleteView, NotificationLogListView
...
urlpatterns = [
    ...
    url(r'^notifications/$', NotificationLogListView.as_view(), name='notify'),
